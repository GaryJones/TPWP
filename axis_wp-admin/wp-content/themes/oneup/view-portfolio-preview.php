...
<div class="pe-ajax-portfolio">
						...
						<nav class="project-filter pe-menu-main">
							<ul class="pe-menu peIsotopeFilter">
								...
								<?php if (ICL_LANGUAGE_CODE == 'en') { ?>
									<li><a class=" active" data-category="" href="#">All</a></li>
									<li><a class="" data-category="hospital" href="#">HOSPITAL</a></li>
									<li><a class="" data-category="long-term-care" href="#">LONG TERM CARE</a></li>
									<li><a class="" data-category="education" href="#">EDUCATION</a></li>
									<li><a class="" data-category="other" href="#">OTHER</a></li>
								<?php } else { ?>
									<li><a class=" active" data-category="" href="#">Tout</a></li>
									<li><a class="" data-category="hopital" href="#">Hôpital</a></li>
									<li><a class="" data-category="chsld" href="#">CHSLD</a></li>
									<li><a class="" data-category="enseignement" href="#">Enseignement</a></li>
									<li><a class="" data-category="autre" href="#">AUTRE</a></li>
								<?php } ?>
							</ul>									
						</nav>
					</div>
	...
	<?php /*<div class="pe-ajax-portfolio-navigation">
		<div>
			<a href="#" class="pe-prev" data-action="prev"><i class="icon-left-open"></i></a>
			<a href="#" class="pe-close" data-action="close"><i class="icon-cancel"></i></a>
			<a href="#" class="pe-next" data-action="next"><i class="icon-right-open"></i></a>
