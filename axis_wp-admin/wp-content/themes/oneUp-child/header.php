...
<!--[if (gte IE 9)|!(IE)]><!--><html class="no-js <?php echo $class ?>" <?php language_attributes();?>><!--<![endif]-->
	...
	<head>
		...
		<style>
			.pe-ajax-portfolio-navigation { margin-bottom: -20px; }
			@media (min-width: 1470px) {
				.desktop .portfolio .peIsotopeGrid .peIsotopeItem:hover div.scalable {
					-webkit-transform: translate3d(0px,-102px,0px);
					-moz-transform: translate3d(0px,-102px,0px);
					transform: translate3d(0px,-102px,0px);
				}

				.ie9 .portfolio .peIsotopeGrid .peIsotopeItem:hover div.scalable{
					-ms-transform: translateY(-102px);
				}
			}
			
			.imgProjectSingle img { float: right; }
		</style>
	</head>
				...
				<div class="pe-container"> 
					<header class="row-fluid">
						<div class="span12">
							...
							<?php if (defined('ICL_LANGUAGE_CODE')): // if WPML is installed, add the lang menu here ?>
							...
							<nav class="pe-menu-main">
								<ul class="pe-menu"><li class="menu-item">
							...
							$languages = icl_get_languages('skip_missing=0');
								...
								if(1 < count($languages)){
									foreach($languages as $l){
										if(!$l['active']){
										//	echo '<li class="menu-item"><a id="switch_languefr" href="'.$l['url'].'">| '.$l['native_name'].'|</a></li>';
										}
									}
								}
							}?>
